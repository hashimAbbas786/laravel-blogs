...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">x
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="/admin/assets/admin/dist/img/profile.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">{{ Auth::user()->name }}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="/admin/assets/admin/dist/img/profile.jpg" class="img-circle" alt="User Image">
    ...
    <script>
        ...
        function addCategory(id) {
          ...
          const option = document.getElementById(`category-${id}`);
